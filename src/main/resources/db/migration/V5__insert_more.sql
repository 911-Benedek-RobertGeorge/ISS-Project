 ...
 INSERT INTO course(course_name, credits, maximum_students,teacher_id, curriculum_id, followers, required)
 VALUES ('Logică matematică si teoria mulţimilor', 6, 200,1, 3, 112, 'MANDATORY'),
        ('Analiză matematică 1 (pe r)', 6, 200,1, 3, 222, 'MANDATORY'),
        ('Geometrie 1 (geometrie analitica)', 6, 200,2,3 , 111, 'MANDATORY'),
        ('Algebra 1 (algebra liniara)', 6, 200,2, 3, 111, 'MANDATORY');
